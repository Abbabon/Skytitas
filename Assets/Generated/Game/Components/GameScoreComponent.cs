...
public partial class GameContext {
    ...
    public Components.GameComponents.ScoreComponent score { get { return scoreEntity.score; } }
    public bool hasScore { get { return scoreEntity != null; } }

    public GameEntity SetScore(int newValue) {
        if (hasScore) {
            throw new Entitas.EntitasException("Could not set Score!\n" + this + " already has an entity with Components.GameComponents.ScoreComponent!",
...
public partial class GameEntity {
    ...
    public Components.GameComponents.ScoreComponent score { get { return (Components.GameComponents.ScoreComponent)GetComponent(GameComponentsLookup.Score); } }
    ...
    public void AddScore(int newValue) {
        ...
        var component = (Components.GameComponents.ScoreComponent)CreateComponent(index, typeof(Components.GameComponents.ScoreComponent));
