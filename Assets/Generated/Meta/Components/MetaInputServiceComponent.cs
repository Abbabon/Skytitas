...
public partial class MetaContext {
    ...
    public Components.MetaComponents.InputServiceComponent inputService { get { return inputServiceEntity.inputService; } }
    public bool hasInputService { get { return inputServiceEntity != null; } }

    public MetaEntity SetInputService(Services.Interfaces.IInputService newInstance) {
        if (hasInputService) {
            throw new Entitas.EntitasException("Could not set InputService!\n" + this + " already has an entity with Components.MetaComponents.InputServiceComponent!",
    ...
    public void ReplaceInputService(Services.Interfaces.IInputService newInstance) {
...
public partial class MetaEntity {
    ...
    public Components.MetaComponents.InputServiceComponent inputService { get { return (Components.MetaComponents.InputServiceComponent)GetComponent(MetaComponentsLookup.InputService); } }
    public bool hasInputService { get { return HasComponent(MetaComponentsLookup.InputService); } }

    public void AddInputService(Services.Interfaces.IInputService newInstance) {
        var index = MetaComponentsLookup.InputService;
        var component = (Components.MetaComponents.InputServiceComponent)CreateComponent(index, typeof(Components.MetaComponents.InputServiceComponent));
