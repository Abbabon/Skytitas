...
public partial class MetaContext {
    ...
    public Components.MetaComponents.CollisionServiceComponent collisionService { get { return collisionServiceEntity.collisionService; } }
    public bool hasCollisionService { get { return collisionServiceEntity != null; } }

    public MetaEntity SetCollisionService(Services.Interfaces.ICollisionService newInstance) {
        if (hasCollisionService) {
            throw new Entitas.EntitasException("Could not set CollisionService!\n" + this + " already has an entity with Components.MetaComponents.CollisionServiceComponent!",
        ...
        entity.AddCollisionService(newInstance);
        return entity;
    }

    public void ReplaceCollisionService(Services.Interfaces.ICollisionService newInstance) {
        var entity = collisionServiceEntity;
        if (entity == null) {
            entity = SetCollisionService(newInstance);
        } else {
            entity.ReplaceCollisionService(newInstance);
        }
    }
...
public partial class MetaEntity {
    ...
    public Components.MetaComponents.CollisionServiceComponent collisionService { get { return (Components.MetaComponents.CollisionServiceComponent)GetComponent(MetaComponentsLookup.CollisionService); } }
    public bool hasCollisionService { get { return HasComponent(MetaComponentsLookup.CollisionService); } }

    public void AddCollisionService(Services.Interfaces.ICollisionService newInstance) {
        var index = MetaComponentsLookup.CollisionService;
        var component = (Components.MetaComponents.CollisionServiceComponent)CreateComponent(index, typeof(Components.MetaComponents.CollisionServiceComponent));
